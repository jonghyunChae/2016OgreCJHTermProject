...
public:
	...
	bool frameStarted(const FrameEvent &evt)
	{
		...
		mProfessorNode->translate(Vector3(0, 0, 50.f * evt.timeSinceLastFrame));
...
public:
	...
	void go(void)
	{
		...
		mWindow = mRoot->initialise(true, "Walking Professor : Copyleft by Dae-Hyun Lee");
